...
class ServiceModelDependencyConventionsTest extends CIUnitTestCase
{
    ...
    private const BASELINE = [
        ...
        // 2026-08-12 (§2.A of docs/audits/2026-08-12-auditoria-parte2-rendimiento-listados-publicos.md):
        // model_call shrank from 7 to 6 — blockInstanceTranslationModel() (and
        // the PHP-side batchResolveListingField()/sortByListingField() it
        // backed) was deleted. filter_by/order_by=field:... now resolve
        // against the materialized cms_entry_facet_values table via real
        // WHERE/ORDER BY joins instead of loading block_data through the
        // Model layer and filtering/sorting it in PHP.
