...
/**
 * HTTP smoke test for MenuController. The configured route group
 ...
 * @internal
 */
final class MenuControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/cms/menus');
    ...
    {
        $result = $this->get('/api/v1/cms/menus/99999');
