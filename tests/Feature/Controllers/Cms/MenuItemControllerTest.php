...
/**
 * HTTP smoke test for MenuItemController. The configured route group
 ...
 * @internal
 */
final class MenuItemControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/cms/menu-items');
    ...
    {
        $result = $this->get('/api/v1/cms/menu-items/99999');
