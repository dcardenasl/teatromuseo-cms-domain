...
/**
 * HTTP smoke test for EntryController. The configured route group
 ...
 * @internal
 */
final class EntryControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/cms/entries');
    ...
    {
        $result = $this->get('/api/v1/cms/entries/99999');
