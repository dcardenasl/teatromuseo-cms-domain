...
/**
 * HTTP smoke test for RedirectController. The configured route group
 ...
 * @internal
 */
final class RedirectControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/cms/redirects');
    ...
    {
        $result = $this->get('/api/v1/cms/redirects/99999');
