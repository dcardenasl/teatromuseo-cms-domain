...
/**
 * HTTP smoke test for BlockInstanceController. The configured route group
 ...
 * @internal
 */
final class BlockInstanceControllerTest extends CIUnitTestCase
{
    ...
    {
        $result = $this->get('/api/v1/cms/pages/1/blocks');
    ...
    {
        $result = $this->get('/api/v1/cms/pages/1/blocks/99999');
