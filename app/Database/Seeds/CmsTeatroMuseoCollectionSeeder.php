...
final class CmsTeatroMuseoCollectionSeeder extends Seeder
{
    ...
    private function definitions(): array
    {
        return [
            ...
            $this->definition('editoriales', 'editoriales', 'Editorial', 'Editorial', 'Éditorial', 'Editorial', 'Publicaciones editoriales del TeatroMuseo.', 'TeatroMuseo editorial publications.', 'Publications éditoriales de TeatroMuseo.', 'Publicações editoriais do TeatroMuseo.', 90, '0.6', 'monthly', false),
