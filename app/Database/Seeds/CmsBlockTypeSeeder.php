            ...
            [
                ...
                'schema_definition' => json_encode([
                    'fields' => [
                        ...
                        'external_url' => ['type' => 'url', 'label' => 'URL externa', 'required' => false],
                    ],
                    'config_fields' => [
                    ...
                    'navigation' => ['source' => 'block_config', 'target' => 'slide_destination'],
                ]),
                'supports_pages'   => 1,
                'supports_entries' => 0,
                'is_container'     => 0,
            ...
            [
                ...
                'schema_definition' => json_encode([
                    ...
                    'config_fields' => [
                        ...
                        'date_field'      => ['type' => 'select', 'label' => 'Fecha visible en tarjeta', 'description' => 'Usa una fecha declarada por la ficha o una fecha editorial estándar.', 'options' => ['auto', 'published_at', 'created_at', 'listing.publication_date', 'listing.start_date', 'listing.end_date', 'listing.opening_date', 'listing.closing_date', 'listing.premiere_date', 'listing.performance_date', 'listing.recorded_at'], 'default' => 'auto', 'required' => false],
                        ...
                        'order_by'        => ['type' => 'select', 'label' => 'Ordenar por',              'required' => false, 'options' => ['published_at', 'sort_order', 'created_at', 'title', 'field:start_date', 'field:end_date', 'field:opening_date', 'field:closing_date'], 'default' => 'published_at'],
                        'order_direction' => ['type' => 'select', 'label' => 'Dirección',                'required' => false, 'options' => ['asc', 'desc', 'upcoming'], 'default' => 'desc'],
            ...
            [
                ...
                'schema_definition' => json_encode([
                    ...
                    'config_fields' => [
                        ...
                        'show_tags'        => ['type' => 'boolean', 'label' => 'Mostrar filtro por etiquetas o tipo', 'description' => 'Muestra chips de filtro sobre el listado. No muestra la etiqueta dentro de cada tarjeta.', 'required' => false, 'default' => false],
                        ...
                        'show_item_categories' => ['type' => 'boolean', 'label' => 'Mostrar clasificación en cada tarjeta', 'description' => 'Muestra la categoría o el tipo del elemento dentro de su tarjeta. No crea filtros.', 'required' => false, 'default' => true],
            ...
            [
                ...
                'schema_definition' => json_encode([
                    'fields' => [
                        ...
                        'profession'   => ['type' => 'string', 'label' => 'Profesión',               'required' => false],
                        'email'        => ['type' => 'email',  'label' => 'Correo público',           'required' => false],
                        'roles'        => ['type' => 'repeater', 'label' => 'Roles adicionales', 'required' => false, 'item_fields' => ['label' => ['type' => 'string', 'label' => 'Rol adicional', 'required' => false]]],
                    ...
                    'config_fields' => [
                        ...
                        'hover_photo' => ['type' => 'media_reference', 'label' => 'Foto al pasar el cursor', 'accept' => 'image', 'required' => false],
                    ],
                ]),
                'supports_pages'   => 1,
                'supports_entries' => 0,
