...
final class CmsTeatroMuseoPageStructureSeeder extends Seeder
{
    ...
    private function definitions(): array
    {
        return [
            ...
            ['collection_key' => 'cursos', 'es_name' => 'TeatroEscuela', 'en_name' => 'TeatroEscuela', 'fr_name' => 'TeatroEscuela', 'pt_name' => 'TeatroEscuela', ...array_combine(['es_slug', 'en_slug', 'fr_slug', 'pt_slug'], array_values(TeatroMuseoPublicRoutes::collectionSlugs('cursos'))), 'sort_order' => 80],
