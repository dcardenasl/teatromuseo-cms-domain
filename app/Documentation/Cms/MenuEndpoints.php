...
/**
 * OpenAPI definitions for Menu endpoints.
 *
                ...
                content: new OA\JsonContent(
                    properties: [
                        ...
                        new OA\Property(
                            property: 'data',
                            type: 'array',
                            items: new OA\Items(ref: '#/components/schemas/MenuResponse')
                        ),
                    ],
                    type: 'object'
                )
    ...
    #[OA\Get(
        ...
        responses: [
            new OA\Response(
                response: 200,
                description: 'Found',
                content: new OA\JsonContent(ref: '#/components/schemas/MenuResponse')
            ),
